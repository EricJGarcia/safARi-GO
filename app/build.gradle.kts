...
android {
    namespace = "com.mobdeve.s13.oplegarcia.ishieric.safarigo"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.mobdeve.s13.oplegarcia.ishieric.safarigo"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
val camerax_version = "1.5.0-alpha03" // CameraX version defined once for clarity

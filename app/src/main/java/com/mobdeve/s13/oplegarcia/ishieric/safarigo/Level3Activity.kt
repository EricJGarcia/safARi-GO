    ...
    private fun processGuess(guess: String) {
        if (guess.equals(targetItem, ignoreCase = true)) {
            ...
            val hint = when (targetItem) {
                "Dog" -> "Hint: I am loyal, bark to communicate, and love to fetch."
                "Hedgehog" -> "Hint: I have spiky quills and roll up to protect myself."
                "Chameleon" -> "Hint: I can change my color to blend into my surroundings."
                else -> "Hint: Try again!"
            }

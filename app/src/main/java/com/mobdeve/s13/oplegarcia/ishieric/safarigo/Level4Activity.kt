...
class Level4Activity : AppCompatActivity() {
    ...
    private val animals = listOf("Shark", "Seal", "Stingray")
    private var currentIndex = 0

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_g1level4) // Ensure this is the correct layout
    ...
    private fun setNewTarget() {
        if (currentIndex >= animals.size) {
            currentIndex = 0
            dbHelper.setLevelCompleted("Level 4")
        ...
        targetImageView.setImageResource(when (targetItem) {
            "Shark" -> R.drawable.shark_image
            "Seal" -> R.drawable.seal_image
            "Stingray" -> R.drawable.stingray_image

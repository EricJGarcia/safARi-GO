    ...
    private fun processGuess(guess: String) {
        if (guess.equals(targetItem, ignoreCase = true)) {
            ...
            val hint = when (targetItem) {
                "Koala" -> "Hint: I live in trees and eat eucalyptus leaves all day."
                "Chicken" -> "Hint: I lay eggs and am often kept on farms."
                "Panda" -> "Hint: I am black and white, and I love to eat bamboo."
                else -> "Hint: Try again!"
            }
    ...
    private fun setNewTarget() {
        if (currentIndex >= animals.size) {
            ...
            Handler(Looper.getMainLooper()).postDelayed({
                val intent = Intent(this, Level8Activity::class.java)
